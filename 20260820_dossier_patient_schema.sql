...
CREATE POLICY "Enable all for authenticated users on patient_vitals" ON public.patient_vitals FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Enable all for authenticated users on patient_problems" ON public.patient_problems FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Enable all for authenticated users on patient_medications" ON public.patient_medications FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Enable all for authenticated users on patient_lab_results" ON public.patient_lab_results FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Enable all for authenticated users on clinical_notes" ON public.clinical_notes FOR ALL TO authenticated USING (true) WITH CHECK (true);
